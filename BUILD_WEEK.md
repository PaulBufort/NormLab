...
| 2026-07-18 | Codex, tâche courante | `build-week-new` | Ajout du lanceur macOS `Lancer NormLab.command` : environnement virtuel local au premier lancement, dépendances du projet puis ouverture automatique de la démo locale | Aucun secret n’est lu ni écrit ; le lanceur appelle `python -m streamlit run demo/app.py` dans son environnement isolé |
| 2026-07-18 | Codex, tâche courante | correction de fiabilité | Un test Sol réel a révélé une réponse `DecisionCard` structurée incomplète à la limite de sortie ; la synthèse est maintenant explicitement concise et sa réserve de sortie passe de 5 000 à 8 000 jetons | Aucun changement du moteur, des équations, budgets, stratégies, métriques ou sémantique de réplication ; test unitaire du budget de synthèse ajouté |
| 2026-07-18 | Codex, tâche courante | correction de garde-fou | Le second test Sol réel a produit une fiche valide mais omis l’avertissement theta/visibilité ; NormLab réinsère désormais localement les avertissements obligatoires avec l’origine `system_guardrail`, puis maintient la vérification bloquante | La sortie Sol n’est pas présentée comme complète seule ; aucune modification scientifique, test d’omission/réparation ajouté |
...
| 2026-07-19 | Codex, tâche courante | préparation candidature | Production du script vidéo anglais chronométré, du plan de tournage, du texte Devpost aligné sur les quatre critères, des métadonnées YouTube, des instructions jury, de la checklist finale et de quatre captures prêtes à téléverser | Matériaux fondés sur les exigences officielles Devpost vérifiées le 19 juillet ; parcours de capture public hors ligne sans appel API ; aucune nouvelle fonctionnalité ni modification scientifique |
